        ...
        <div className='bg-white p-4 shadow'>
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <button className='justify-content flex h-12 items-center rounded-sm border border-orange bg-orange/10 px-5 capitalize text-orange shadow-sm hover:bg-orange/5'>
                  <svg
