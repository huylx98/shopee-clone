...
export default function AsideFilter() {
  return (
    <div className='py-4 '>
      <Link to={path.home} className='tems-center flex font-bold'>
        <svg viewBox='0 0 12 10' className='mr-3 w-3 fill-current'>
      ...
      <Link to={path.home} className='tems-center mt-4 flex font-bold uppercase'>
        <svg
      ...
      <div className='my-4 h-[1px] bg-gray-300' />
      <Button className='flex w-full items-center justify-center bg-orange p-2 text-sm uppercase text-white'>
        Xoá tất cả
      </Button>
    </div>
  )
