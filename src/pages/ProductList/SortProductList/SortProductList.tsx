...
export default function SortProductList() {
  return (
    <div className='bg-gray-300/40 py-3 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button className='h-8 bg-white px-4 text-center capitalize text-black hover:bg-slate-100/80'>
            Mới nhất
          </button>
          <button className='h-8 bg-white px-4 text-center capitalize text-black hover:bg-slate-100/80'>
            Bán chạy
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2'>
            ...
            <button className='h-8 cursor-not-allowed rounded-tr-sm rounded-br-sm bg-white px-3 shadow hover:bg-slate-100'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
