    ...
    <Link to={path.home}>
      <div className='overflow-hidden rounded-sm bg-white shadow transition-transform duration-100 hover:translate-y-[-0.03rem] hover:shadow-md'>
        <div className='relative w-full pt-[100%]'>
          <img
            src='https://cf.shopee.vn/file/vn-11134201-7qukw-lephjz4k2pbm14_tn'
            alt=''
        ...
        <div className='overflow-hidden p-2'>
          <div className='min-h-[2rem] text-xs line-clamp-2'>
            Quần Kaki Thể Thao Jogger Cao Cấp VICENZO Dáng Thể Thao Cạp Chun Bo Gấu. Quần Jogger Kaki Nam Bo Chun QJKN01
          </div>
          <div className='mt-3 flex items-center'>
            <div className='max-w-[50%] truncate text-gray-500 line-through'>₫158.000</div>
